...
;printks "before: %f, to: %f\\n", 1, gk_old_1, gkrate1
;if (gkrate1 = gk_old_1) then
;    kgoto skip
;elseif (gk_change = 1) then
;    kgoto started
;else
;    gk_change = 1
;    kgoto start
;endif
;if gk_change = 0 kgoto skip
;start:
;gk_old_1 = gkrate1
;started:
gkrate1	portk gkrate_in1, .0001
;printks "gkrate_in1: %f, gkrate1: %f\\n", 1, gkrate_in1, gkrate1
;gk_change = 1
;Sval1 sprintfk "%f", gkrate1
;printks "val1: %S", Sval1
;if (gkrate1 = gk_old_1) then
;    printks "equal! gk_old_1: %f, gkrate1: %f\\n", 1, gk_old_1, gkrate1
;    kgoto skip
;else
 ;   kgoto changing
;endif

...
FLcolor 230,230,224
gkosc1freq, giosc1freqhandle   FLknob  "freq", 0, 127, 0, 3, ihandleosc1freqval, $KNOBWIDTH, $FIRSTROWOFFSETX+$KNOBOFFSETX , $FIRSTROWOFFSETY+$KNOBOFFSETY
gkosc1shape, giosc1shapehandle FLknob  "shape", 0, 1, 0, 3, ihandleosc1shapeval, $KNOBWIDTH, $FIRSTROWOFFSETX+$KNOBOFFSETX+$HORDIST , $FIRSTROWOFFSETY+$KNOBOFFSETY
gkosc1lev1, giosc1lev1handle   FLknob  "sineLevel", 0, 1, 0, 3, ihandleosc1lev1val,  $KNOBWIDTH, $FIRSTROWOFFSETX+$KNOBOFFSETX+2*$HORDIST, $FIRSTROWOFFSETY+$KNOBOFFSETY
gkosc1lev2, giosc1lev2handle   FLknob  "sawLevel", 0, 1, 0, 3, ihandleosc1lev2val, $KNOBWIDTH, $FIRSTROWOFFSETX+$KNOBOFFSETX+3*$HORDIST, $FIRSTROWOFFSETY+$KNOBOFFSETY
FLcolor -1
...
FLcolor 230,224,224
gkringlevel,    giringhandle         FLknob  "level", 0, 1, 0, 3, ihandleringval, $KNOBWIDTH, $FIRSTROWOFFSETX+$KNOBOFFSETX+5*$HORDIST , $FIRSTROWOFFSETY+$KNOBOFFSETY
FLcolor -1
...
FLcolor 100,150,254
gkfiltosc_freq, gifiltosc_freqhandle FLknob  "freq", 0, 1, 0, 3, ihandlefiltosc_freqval, $KNOBWIDTH, $FIRSTROWOFFSETX+$KNOBOFFSETX+7*$HORDIST , $FIRSTROWOFFSETY+$KNOBOFFSETY
gkfiltosc__resp,gifiltosc_resphandle FLknob  "response", 0, 1, 0, 3, ihandlefiltosc_respval,  $KNOBWIDTH, $FIRSTROWOFFSETX+$KNOBOFFSETX+8*$HORDIST, $FIRSTROWOFFSETY+$KNOBOFFSETY
gkfiltosc_levl, gifiltosc_levlhandle FLknob  "level", 0, 1, 0, 3, ihandlefiltosc_levlval, $KNOBWIDTH, $FIRSTROWOFFSETX+$KNOBOFFSETX+9*$HORDIST, $FIRSTROWOFFSETY+$KNOBOFFSETY
FLcolor -1
FLsetVal_i  7.0, giosc1freqhandle
FLsetVal_i  .52, giosc1shapehandle
FLsetVal_i  .75, giosc1lev1handle
FLsetVal_i  .1, giosc1lev2handle
FLsetTextSize  10, giosc1freqhandle
FLsetTextSize  10, giosc1shapehandle
FLsetTextSize  10, giosc1lev1handle
FLsetTextSize  10, giosc1lev2handle
FLsetBox 1, ihandleosc1freqval
FLsetBox 1, ihandleosc1shapeval
FLsetBox 1, ihandleosc1lev1val
FLsetBox 1, ihandleosc1lev2val
FLsetVal_i  .66, giringhandle
FLsetVal_i  .5, gifiltosc_freqhandle
FLsetVal_i  .9, gifiltosc_resphandle
FLsetVal_i  .5, gifiltosc_levlhandle
FLsetTextSize  10, giringhandle
FLsetTextSize  10, gifiltosc_freqhandle
FLsetTextSize  10, gifiltosc_resphandle
FLsetTextSize  10, gifiltosc_levlhandle
...
FLcolor 230,223,230
gkosc2freq, giosc2freqhandle  FLknob  "freq", 0, 5, 0, 3, ihandleosc2freqval,$KNOBWIDTH, $SECONDROWOFFSETX+$KNOBOFFSETX , $SECONDROWOFFSETY+$KNOBOFFSETY
gkosc2shape,giosc2shapehandle FLknob  "shape", 0, 1, 0, 3, ihandleosc2shapeval, $KNOBWIDTH, $SECONDROWOFFSETX+$KNOBOFFSETX+$HORDIST , $SECONDROWOFFSETY+$KNOBOFFSETY
gkosc2lev1, giosc2lev1handle  FLknob  "pulseLevel", 0, 1, 0, 3, ihandleosc2lev1val,  $KNOBWIDTH, $SECONDROWOFFSETX+$KNOBOFFSETX+2*$HORDIST, $SECONDROWOFFSETY+$KNOBOFFSETY
gkosc2lev2, giosc2lev2handle  FLknob  "rampLevel", 0, 1, 0, 3, ihandleosc2lev2val, $KNOBWIDTH, $SECONDROWOFFSETX+$KNOBOFFSETX+3*$HORDIST, $SECONDROWOFFSETY+$KNOBOFFSETY
FLcolor -1
...
FLcolor 254,50,50
gkenv_attack, giattack_envhandle FLknob  "attack", 0, 10, 0, 3, ihandleenv_attackval, $KNOBWIDTH, $SECONDROWOFFSETX+$KNOBOFFSETX+5*$HORDIST,  $SECONDROWOFFSETY+$KNOBOFFSETY
gkenv_on, gienv_onhandle FLknob  "on", 0, 1, 0, 3, ihandleenv_onval, $KNOBWIDTH, $SECONDROWOFFSETX+$KNOBOFFSETX+6*$HORDIST , $SECONDROWOFFSETY+$KNOBOFFSETY
gkenv_decay, gienv_decayhandle FLknob  "decay", 0, 10, 0, 3, ihandleenv_decayval,  $KNOBWIDTH, $SECONDROWOFFSETX+$KNOBOFFSETX+7*$HORDIST, $SECONDROWOFFSETY+$KNOBOFFSETY
gkenv_off, gienv_offhandle FLknob  "off", 0, 1, 0, 3, ihandleenv_offval, $KNOBWIDTH, $SECONDROWOFFSETX+$KNOBOFFSETX+8*$HORDIST, $SECONDROWOFFSETY+$KNOBOFFSETY
gkenv_trap, gienv_traphandle FLknob  "trapezoid", 0, 1, 0, 3, ihandleenv_trapval,  $KNOBWIDTH, $SECONDROWOFFSETX+$KNOBOFFSETX+9*$HORDIST, $SECONDROWOFFSETY+$KNOBOFFSETY
gkenv_sig, gienv_sighandle FLknob  "signal", 0, 1, 0, 3, ihandleenv_sigval, $KNOBWIDTH, $SECONDROWOFFSETX+$KNOBOFFSETX+10*$HORDIST, $SECONDROWOFFSETY+$KNOBOFFSETY
FLcolor -1
FLsetVal_i  1.0, giosc2freqhandle
FLsetVal_i  0.0, giosc2shapehandle
FLsetVal_i  0.75, giosc2lev1handle
FLsetVal_i  .6, giosc2lev2handle
FLsetTextSize  10, giosc2freqhandle
FLsetTextSize  10, giosc2shapehandle
FLsetTextSize  10, giosc2lev1handle
FLsetTextSize  10, giosc2lev2handle
FLsetBox 1, ihandleosc2freqval
FLsetBox 1, ihandleosc2shapeval
FLsetBox 1, ihandleosc2lev1val
FLsetBox 1, ihandleosc2lev2val
FLsetVal_i  .25, giattack_envhandle
FLsetVal_i  0.0, gienv_onhandle
FLsetVal_i  7.75, gienv_decayhandle
FLsetVal_i  1.0, gienv_offhandle
FLsetVal_i  .66, gienv_traphandle
FLsetVal_i  1.0, gienv_sighandle
FLsetTextSize  10, giattack_envhandle
FLsetTextSize  10, gienv_onhandle
FLsetTextSize  10, gienv_decayhandle
FLsetTextSize  10, gienv_offhandle
FLsetTextSize  10, gienv_traphandle
FLsetTextSize  10, gienv_sighandle
...
FLcolor 200,250,230
gkosc3freq, giosc3freqhandle  FLknob  "freq", 0, 5, 0, 3, ihandleosc3freqval, $KNOBWIDTH, $THIRDROWOFFSETX+$KNOBOFFSETX , $THIRDROWOFFSETY+$KNOBOFFSETY
gkosc3shape,giosc3shapehandle FLknob  "shape", 0, 1, 0, 3, ihandleosc3shapeval, $KNOBWIDTH, $THIRDROWOFFSETX+$KNOBOFFSETX+$HORDIST , $THIRDROWOFFSETY+$KNOBOFFSETY
gkosc3lev1, giosc3lev1handle  FLknob  "pulseLevel", 0, 1, 0, 3, ihandleosc3lev1val,  $KNOBWIDTH, $THIRDROWOFFSETX+$KNOBOFFSETX+2*$HORDIST, $THIRDROWOFFSETY+$KNOBOFFSETY
gkosc3lev2, giosc3lev2handle  FLknob  "rampLevel", 0, 1, 0, 3, ihandleosc3lev2val, $KNOBWIDTH, $THIRDROWOFFSETX+$KNOBOFFSETX+3*$HORDIST, $THIRDROWOFFSETY+$KNOBOFFSETY
FLcolor -1
...
FLcolor 200,200,254
gkrvb_mix, girvb_mixhandle FLknob  "mix", 0, 1, 0, 3, ihandlervb_mixval, $KNOBWIDTH, $THIRDROWOFFSETX+$KNOBOFFSETX+5*$HORDIST, $THIRDROWOFFSETY+$KNOBOFFSETY
gkrvb_level, girvb_levelhandle FLknob  "level", 0, 1, 0, 3, ihandlervb_levelval, $KNOBWIDTH, $THIRDROWOFFSETX+$KNOBOFFSETX+6*$HORDIST , $THIRDROWOFFSETY+$KNOBOFFSETY
FLcolor -1
FLsetVal_i  3.05, giosc3freqhandle
FLsetVal_i  0.33, giosc3shapehandle
FLsetVal_i  0.00, giosc3lev1handle
FLsetVal_i  0.25, giosc3lev2handle
FLsetTextSize  10, giosc3freqhandle
FLsetTextSize  10, giosc3shapehandle
FLsetTextSize  10, giosc3lev1handle
FLsetTextSize  10, giosc3lev2handle
FLsetBox 1, ihandleosc3freqval
FLsetBox 1, ihandleosc3shapeval
FLsetBox 1, ihandleosc3lev1val
FLsetBox 1, ihandleosc3lev2val
FLsetVal_i  1.0, girvb_mixhandle
FLsetVal_i  .5, girvb_levelhandle
FLsetTextSize  10, girvb_mixhandle
FLsetTextSize  10, girvb_levelhandle
...
FLcolor 100,100,210
gknoisecolor, ginoisecolorhandle FLknob  "color", 0, 1, 0, 3, ihandlenoisecolorval, $KNOBWIDTH, $FOURTHROWOFFSETX+$KNOBOFFSETX , $FOURTHROWOFFSETY+$KNOBOFFSETY
gknoiselevel, ginoiselevelhandle FLknob  "level", 0, 1, 0, 3, ihandlenoiselevelval, $KNOBWIDTH, $FOURTHROWOFFSETX+$KNOBOFFSETX+$HORDIST , $FOURTHROWOFFSETY+$KNOBOFFSETY
FLcolor -1
FLsetVal_i  0.4, ginoisecolorhandle
FLsetVal_i  0.75, ginoiselevelhandle
FLsetTextSize  10, ginoisecolorhandle
FLsetTextSize  10, ginoiselevelhandle
...
gkKeyTrig, giTrigHandle FLbutton  "keyTrig ON/OFF", 1, 0, 2, $KNOBWIDTH+40, $KNOBWIDTH+5,  $THIRDROWOFFSETX+$KNOBOFFSETX+7*$HORDIST-20, $THIRDROWOFFSETY+$KNOBOFFSETY, -1, 105, 80,  0, 1
FLsetBox 1, ihandleKeyOffset
FLsetBox 1, ihandleKeyRange
FLsetTextSize  10, iKeyOhandle
FLsetTextSize  10, iKeyRhandle
FLsetTextSize  9, giTrigHandle
...
gk9,ih	FLbutton	"Store snapshot to current index",  3,0, 11,150,40,200,140,    0,37,0,0,0,0
...
;-------------------------------------------------------------------------------
; instrs 1-10 by Steven Cook, often tweaked by Ben McAllister - http://www.listenfaster.com
;-------------------------------------------------------------------------------
;-------------------------------------------------------------------------------
...
afreq	=	kfreq + afmod  ; Add FM sources and tune to A=440
printks "kfreq: %f, afmod: %f\n", .1, kfreq, afmod
;afreq	tablei	afreq/12544, 7, 1        ; Linear to exponential convertor
ri:
...
;gaKeyb	init	(ioct-8)* 127 + i(gkKeyOffset)
gaKeyb init icps

printks "ioct: %f, gaKeyb: %f\n", .1, ioct, gaKeyb
gktrig	init	1
gktrig1	init	1
gktrig2	init	1
gktrig3	init	1
...
FLloadsnap	"vcs3_snap.txt"
	...
	instr 37	
printks	"FLSetsnap - gkCheck: %f", 0, gkCheck
...
gkosc1freq = kdata2 
;printks "val: %f\n", .1, gkosc1freq
;gkosc1freq portk gkosc1freq, .025
...
;
;	For some reason, you get more granularity to the
;	control like this:
;gkosc1lev1 tonek gkosc1lev1, 20
;gkosc1lev1 portk gkosc1lev1, .025
FLsetVal  kdata1,gkosc1lev1, giosc1lev1handle
knob4:
if	kstatus != 176 kgoto end
if	kdata1 != 84 kgoto knob5
gkosc1lev2 = (kdata2 * .00787)
FLsetVal  kdata1,gkosc1lev2, giosc1lev2handle
knob5:
if	kstatus != 176 kgoto end
if	kdata1 != 89 kgoto knob6
gkosc2freq = (kdata2 * .0393)
FLsetVal  kdata1,gkosc2freq, giosc2freqhandle
knob6:
if	kstatus != 176 kgoto end
if	kdata1 != 90 kgoto knob7
gkosc2shape = (kdata2 * .00787)
FLsetVal  kdata1,gkosc2shape, giosc2shapehandle
knob7:
if	kstatus != 176 kgoto end
if	kdata1 != 91 kgoto knob8
gkosc2lev1 = (kdata2 * .00787)
FLsetVal  kdata1,gkosc2lev1, giosc2lev1handle
knob8:
if	kstatus != 176 kgoto end
if	kdata1 != 92 kgoto knob9
gkosc2lev2 = (kdata2 * .00787)
FLsetVal  kdata1,gkosc2lev2, giosc2lev2handle
knob9:
if	kstatus != 176 kgoto end
if	kdata1 != 97 kgoto knob10
gkosc3freq = (kdata2 * .0393)
FLsetVal  kdata1,gkosc3freq, giosc3freqhandle
knob10:
if	kstatus != 176 kgoto end
if	kdata1 != 98 kgoto knob11
gkosc3shape = (kdata2 * .00787)
FLsetVal  kdata1,gkosc3shape, giosc3shapehandle
knob11:
if	kstatus != 176 kgoto end
if	kdata1 != 99 kgoto knob12
gkosc3lev1 = (kdata2 * .00787)
FLsetVal  kdata1,gkosc3lev1, giosc3lev1handle
knob12:
if	kstatus != 176 kgoto end
if	kdata1 != 100 kgoto envSection
gkosc3lev2 = (kdata2 * .00787)
FLsetVal  kdata1,gkosc3lev2, giosc3lev2handle
;
;env part
;
envSection:
if	kstatus != 176 kgoto end
if	kdata1 != 1 kgoto env2
gkenv_attack = (kdata2 * .0787)
FLsetVal  kdata1,gkenv_attack, giattack_envhandle
env2:
if	kstatus != 176 kgoto end
if	kdata1 != 2 kgoto env3
gkenv_on = (kdata2 * .00787)
FLsetVal  kdata1,gkenv_on, gienv_onhandle
env3:
if	kstatus != 176 kgoto end
if	kdata1 != 3 kgoto env4
gkenv_decay = (kdata2 * .0787)
FLsetVal  kdata1,gkenv_decay, gienv_decayhandle
env4:
if	kstatus != 176 kgoto end
if	kdata1 != 4 kgoto env5
gkenv_off = (kdata2 * .00787)
FLsetVal  kdata1,gkenv_off, gienv_offhandle
env5:
if	kstatus != 176 kgoto end
if	kdata1 != 5 kgoto env6
gkenv_trap = (kdata2 * .00787)
FLsetVal  kdata1,gkenv_trap, gienv_traphandle
env6:
if	kstatus != 176 kgoto end
if	kdata1 != 6 kgoto extra_row1
gkenv_sig = (kdata2 * .00787)
FLsetVal  kdata1,gkenv_sig, gienv_sighandle
extra_row1:
ring:
if	kstatus != 176 kgoto end
if	kdata1 != 85 kgoto filt1
gkringlevel = (kdata2 * .00787)
FLsetVal  kdata1,gkringlevel,giringhandle
filt1:
if	kstatus != 176 kgoto end
if	kdata1 != 86 kgoto filt2
gkfiltosc_freq = (kdata2 * .00787)
FLsetVal  kdata1,gkfiltosc_freq, gifiltosc_freqhandle
filt2:
if	kstatus != 176 kgoto end
if	kdata1 != 87 kgoto filt3
gkfiltosc__resp = (kdata2 * .00787)
FLsetVal  kdata1,gkfiltosc__resp, gifiltosc_resphandle
filt3:
if	kstatus != 176 kgoto end
if	kdata1 != 88 kgoto extra_row2
gkfiltosc_levl = (kdata2 * .00787)
FLsetVal  kdata1,gkfiltosc_levl, gifiltosc_levlhandle
extra_row2:
noise1:
if	kstatus != 176 kgoto end
if	kdata1 != 95 kgoto noise2
gknoisecolor = (kdata2 * .00787)
FLsetVal  kdata1,gknoisecolor, ginoisecolorhandle
noise2:
if	kstatus != 176 kgoto end
if	kdata1 != 96 kgoto extra_row3
gknoiselevel = (kdata2 * .00787)
FLsetVal  kdata1,gknoiselevel, ginoiselevelhandle
extra_row3:
rvb1:
if	kstatus != 176 kgoto end
if	kdata1 != 103 kgoto rvb2
gkrvb_mix = (kdata2 * .00787)
FLsetVal  kdata1,gkrvb_mix, girvb_mixhandle
rvb2:
if	kstatus != 176 kgoto end
if	kdata1 != 104 kgoto buttons
gkrvb_level = (kdata2 * .00787)
FLsetVal  kdata1,gkrvb_level, girvb_levelhandle
buttons:
;if	kstatus != 176 kgoto end
;if	kdata1 != 105 kgoto end
;if	kdata2 != 0 kgoto notzero
;gkKeyTrig = 0
;notzero:
;gkKeyTrig = 1
;FLsetVal  1,gkKeyTrig, giTrigHandle
end:
...
;
; bass and treble - not yet impl'd
;
...
i1  0   36000    7.000  0.52   0.75   0.10
i2  0   36000    1.000  0.00   0.75   0.60   0
i3  0   36000    3.050  0.33   0.00   0.25   0      1
i4  0   36000    0.40   0.75
i5  0   36000    1   
i6  0   36000    0.50   0.90   0.50
i10 0   36000    0.25   0.00   7.75   1.00   0.66   1.00
i7  0   36000    0.66
i8  0   36000    1.00   0.50
i9  0   36000    0.10   0.10   1.33   2.77
i11 0 36000  
i70 0 36000
i99 0   36000    0.70   0.00   1.00   0.70   0.50   0.50
i80 0 36000
i81 0 36000
i82 0 36000
i83 0 36000

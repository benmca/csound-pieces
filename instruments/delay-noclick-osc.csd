...
if kstarted == 0 then
OSCsend 1, "$DestIP", 9000, "/1/fader1", "f", (kdelay_tap_point / (gkmaxdel - gimin)) + gimin
OSCsend 1, "$DestIP", 9000, "/1/rotary1", "f", kregeneration_scalar
OSCsend 1, "$DestIP", 9000, "/1/toggle1", "f", kinput_on_off
OSCsend 1, "$DestIP", 9000, "/1/toggle2", "f", koutput_on_off
OSCsend 1, "$DestIP", 9000, "/1/rotary2", "f", kinput_volume
OSCsend 1, "$DestIP", 9000, "/1/rotary3", "f", koutput_volume
kstarted = 1
endif
...
;FLsetVal	1, krate1, gihtap1
		printks "krate: %f \n", .1, krate1
		printks "gidelsize: %f \n", .1, gidelsize
OSCsend (krate1 / gidelsize), "$DestIP", 9000, "/1/fader1", "f", (krate1 / gidelsize)
...
if kstarted == 0 then
OSCsend 1, "$DestIP", 9000, "/1/fader2", "f", (kdelay_tap_point / (gkmaxdel - gimin)) + gimin
OSCsend 1, "$DestIP", 9000, "/1/rotary4", "f", kregeneration_scalar
OSCsend 1, "$DestIP", 9000, "/1/toggle3", "f", kinput_on_off
OSCsend 1, "$DestIP", 9000, "/1/toggle4", "f", koutput_on_off
OSCsend 1, "$DestIP", 9000, "/1/rotary5", "f", kinput_volume
OSCsend 1, "$DestIP", 9000, "/1/rotary6", "f", koutput_volume
kstarted = 1
endif
...
;FLsetVal	1, krate1, gihtap1
		printks "krate: %f \n", .1, krate1
		printks "gidelsize: %f \n", .1, gidelsize
OSCsend (krate1 / gidelsize), "$DestIP", 9000, "/1/fader2", "f", (krate1 / gidelsize)
		printks "fader set to : %f \n", .1, (krate1 / gidelsize)
kdelay_tap_point = krate1

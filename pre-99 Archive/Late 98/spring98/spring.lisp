...
(defun phraseone (st)
  (algorithm nil main (start st length 14)
	     ...
	     (setf amp (* (* 6 (between .75 1.3)) (item (items 4 2 1 1 2 1 2 1 1 2 1 1 2 4))))
...
(defun phrasethree (st)
  (algorithm nil main (start st length 30)
	     ...
	     (setf amp (item (items    4 2 1 1 2 2 1 2 .35 1 1 2 1 1 1 [1 1 .25])))
	     (setf phrase (item (items 3 0 0 0 1 0 2 2 2   2 1 0 0 2 2 [2 3 2])))
	     (setf rhythm (item (rhythms w. 12 12 12 32 e e e e 32 12 12 12 q e w. tempo (tempo 0 50 1 80 5 87 6 60 9 72 10 56 12 64 16 50))))
...
(defun phrasefour (st)
  (algorithm nil main (start st length 30)
	     (setf instr (item (items  3 3 3 3 3 3 2 3 4   3 3 3 3 2 2 [2 3 4])))
	     (setf pitch (item (pitches e2 d d d d e g4 e d2 d2 d d d e g [b4 b2 b2])))
	     (setf endpitch (item (pitches e2 d e fs gs as gs4 e d2 e2 d d d e g [b4 b2 b2])))
	     (setf amp (item (items    4 2 1 1 2 2 1 2 .35 1 1 2 1 1 1 [1 2 .25])))
	     (setf phrase (item (items 3 0 0 0 1 0 2 2 0 2 1 0 0 0 1 [2 3 2])))
	     (setf rhythm (item (rhythms w. 12 12 12 32 e e e e 32 12 12 12 q e w. tempo (tempo 0 50 1 80 5 87 6 60 9 72 10 56 12 64 16 50))))
	     (setf angle (between 40 50))
	     (if (= instr 2)
		 (progn

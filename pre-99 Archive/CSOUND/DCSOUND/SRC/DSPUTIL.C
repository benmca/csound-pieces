...
void FrqToPhase(
    MYFLT *buf, long size, MYFLT incr, MYFLT sampRate, MYFLT fixUp)
...
void MakeSinc(void)             /* initialise our static sinc table */
{
    ...
    MYFLT   dtheta  = (MYFLT)(SBW*PI)/(MYFLT)SPTS;   /* SBW lowers cutoff to redc ali */

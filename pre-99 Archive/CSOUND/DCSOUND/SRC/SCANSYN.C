...
#if PHASE_INTERP == 3
#define pinterp(ii, t) \
        (pp->x1[p->t[(int)ii]] + (-pp->x3[p->t[(int)ii]]*FL(0.5) + (pp->x3[p->t[(int)ii]]*FL(0.5) - pp->x1[p->t[(int)ii]] + pp->x2[p->t[(int)ii]]*FL(0.5)) + pp->x2[p->t[(int)ii]]*FL(0.5)))
#else
#define pinterp(ii, t) \
        (pp->x2[p->t[(int)ii]] + (pp->x1[p->t[(int)ii]] - pp->x2[p->t[(int)ii]]) * t)
#endif

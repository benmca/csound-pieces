...
;         icondfn, scnrat,  ivelf, imasf, ispgmtrxf, icntrf, idampf, kmasf, kspgstf, kcntr, kdamp, ilplkpos, irplkpos, kpos, kstrngth, ain, idisp, id
   scanu  icondfn,    .05,  ivelf, imasf, ispgmtrxf, icntrf, idampf,     2, kspgstf,    .2,  -.05,      .1,        .5,   .5,       0,   a0,  idisp,  1
...
; Sine wave
f9 0 1024 10 1
; STIFFNESS STUDY - DYNAMIC
i1 0 5   80 7.00 1 1 2 6 3 4  5 .01 1
i1 + 2   80 7.00 1 1 2 6 3 4  5 1  .01
i1 + .   80 7.07 1 1 2 6 3 4  55 .01 1
i1 + 5   80 8.00 1 1 2 6 3 4  555 .6  .01
i1 + 2   80 7.00 1 11 2 66 33 44  5 .01 .6
i1 + .   80 7.07 1 11 2 66 33 44  55 .6  .01
i1 + 5   80 8.00 1 11 2 66 33 44  555 .01 .6
i1 + 2   80 7.00 1 111 2 666 333 444 5 .6  .01
i1 + .   80 7.07 1 111 2 666 333 444 55 .01 .6
i1 + 5   80 8.00 1 111 2 666 333 444 555 .6  .01
i1 + 2   80 7.00 1 1111 2 6666 3333 4444 5 .01 .6
i1 + .   80 7.07 1 1111 2 6666 3333 4444 55 .6  .01
i1 + 12  80 8.00 1 1111 2 6666 3333 4444 555 .01 .6
e
</CsScore>
</CsoundSynthesizer>

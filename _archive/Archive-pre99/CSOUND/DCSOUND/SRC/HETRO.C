...
#ifdef CWIN
        {
extern int __cdecl hetro_dialog(MYFLT *, int *, MYFLT *, MYFLT *,
                                MYFLT *, short *, double *, int *,
                                int *, MYFLT *, char **, char **);
...
/*    sdif_int32  frame_id = 1; */
    ...
    for (i=0;i < num_pts;i++) {
      sdif_float32 amp,freq,phase = 0.0f; /* can't offer anything interesting with phase! */

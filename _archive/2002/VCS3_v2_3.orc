...
;   Some tweaks and all GUI by Ben McAllister - benmca@drizzle.com
;-------------------------------------------------------------------------------
sr     = 22050  
kr     = 2205 
ksmps  = 10
...
FLpanel	"VCS3",1200,1000,100,100
...
itopboxring  FLbox  "RING", 1, 1, 10, 100, 20, $FIRSTROWOFFSETX+450, $FIRSTROWOFFSETY 
itopboxfilt  FLbox  "Filter Osc", 1, 1, 10, 100, 20, $FIRSTROWOFFSETX+550, $FIRSTROWOFFSETY 
...
gkosc3freq, iosc3freqhandle FLknob  "freq", 0, 20, 0, 3, ihandleosc3freqval, $KNOBWIDTH, $THIRDROWOFFSETX+$KNOBOFFSETX , $THIRDROWOFFSETY+$KNOBOFFSETY
...
gkrvb_mix, irvb_mixhandle FLknob  "mix", 0, 1, 0, 3, ihandlervb_mixval, $KNOBWIDTH, $THIRDROWOFFSETX+$KNOBOFFSETX+500, $THIRDROWOFFSETY+$KNOBOFFSETY
...
iboxhandlex4  FLbox  "trap amp in", 1, 1, 10, 25, 100, $BUTTONBANKORGX+75, $BUTTONBANKORGY-100
iboxhandlex5  FLbox  "ring mod a", 1, 1, 10, 25, 100, $BUTTONBANKORGX+100, $BUTTONBANKORGY-100
iboxhandlex6  FLbox  "ring mod b", 1, 1, 10, 25, 100, $BUTTONBANKORGX+125, $BUTTONBANKORGY-100
iboxhandlex7  FLbox  "rvb in", 1, 1, 10, 25, 100, $BUTTONBANKORGX+150, $BUTTONBANKORGY-100
iboxhandlex8  FLbox  "filt in", 1, 1, 10, 25, 100, $BUTTONBANKORGX+175, $BUTTONBANKORGY-100
iboxhandlex9  FLbox  "osc 1 FM", 1, 1, 10, 25, 100, $BUTTONBANKORGX+200, $BUTTONBANKORGY-100
iboxhandlex10  FLbox  "osc 2 FM", 1, 1, 10, 25, 100, $BUTTONBANKORGX+225, $BUTTONBANKORGY-100
iboxhandlex11  FLbox  "osc 3 FM", 1, 1, 10, 25, 100, $BUTTONBANKORGX+250, $BUTTONBANKORGY-100
iboxhandlex12  FLbox  "decay mod", 1, 1, 10, 25, 100, $BUTTONBANKORGX+275, $BUTTONBANKORGY-100
iboxhandlex13  FLbox  "rvb mix mod", 1, 1, 10, 25, 100, $BUTTONBANKORGX+300, $BUTTONBANKORGY-100
iboxhandlex14  FLbox  "filter freq mod", 1, 1, 10, 25, 100, $BUTTONBANKORGX+325, $BUTTONBANKORGY-100
...
;-------------------------------------------------------------------------------
; instrs 1-10 by Steven Cook, modified by Ben McAllister
;-------------------------------------------------------------------------------

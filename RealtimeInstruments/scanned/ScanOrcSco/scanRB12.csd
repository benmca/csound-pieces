...
;         icondfn,iscnrat,ivelf,imasf, ispgmtrxf, icntrf, idampf, kmasf, kspgstf, kcntr, kdamp,ilplkpos,irplkpos, kpos, kstrngth, ain, idisp, id
   scanu  icondfn,iscnrat,ivelf,imasf, ispgmtrxf, icntrf, idampf, kmasf, kspgstf, kcntr, kdamp,ilplkpos,irplkpos,   .5,       0,   a0,  idisp,  1
...
; Sine wave
f9 0 1024 10 1
; LRPLUCK STUDY - NOTE P7 < 0
i1 0 2   80 7.00 1 -1     2 66 33  44 5   .2  .2   2  2  .2  .4  .05 -.2  -.02  .1  .5
i1 + 5   80 8.00 1 -1     2 66 33  44 55  .2  .2   2  2  .3  .01 .01 -.04 -.2   .5  .4
i1 + 2   80 7.00 1 -11    2 66 33  44 5   .2  .2   2  2  .1  .2  .1  -.3  -.03  .9  .1
i1 + 10  80 8.00 1 -11    2 66 33  44 55  .2  .2   2  2  .5  .01 .02 -.2  -.05  .2  .1
e
</CsScore>
</CsoundSynthesizer>

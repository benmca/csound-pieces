...
(sprout (list 
         (timesig_mix 220.0 10 1.0 50 1.0)
         (timesig_mix 220.0 45 1.0 50 1.0)
         (timesig_mix 220.0 80 1.0 50 1.0)
         (timesig_mix 220.0 10 1.0 50 .5)
         (timesig_mix 220.0 45 1.0 50 .5)
         (timesig_mix 220.0 80 1.0 50 .5)
         (timesig_mix 220.0 10 1.0 50 .25)
         (timesig_mix 220.0 45 1.0 50 .25)
         (timesig_mix 220.0 80 1.0 50 .25)
         (make-reverb-note 55)
         ) "timesig.sco" :play #t :orchestra "timesig.orc" :header "f1 0 262144 1 \"jam.aif\" 0  0 0\nf2 0 16384 9 .5 1 0
    \n")

(sprout (timesig_mix 320.0 10 1.0 50 1.0)  "timesig.sco" :play #t :orchestra "timesig.orc" :header "f1 0 262144 1 \"jam.aif\" 0  0 0\nf2 0 16384 9 .5 1 0\n")
;
; make-reverb-note

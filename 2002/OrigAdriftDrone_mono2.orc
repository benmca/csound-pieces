...
gk2,ih22	FLslider	"Grain Density", 1, 100, 0 ,5, ih2, 300,15, 20,150
gk3,ih33	FLslider	"Grain Duration", .001, .1, 0 ,5, ih3, 300,15, 20,250
...
;************ release section **********************
rel:
kmp1	linseg  1,ireltime-idecay,1,idecay,0
done:
kmp     =       kmp1*gk1
kgrainamp = kmp1*gk7
ksineamp = kmp1*gk8

...
container = (
    Line().with_rhythm(Itemstream('q'.split() , notetype=notetypes.rhythm, streammode=streammodes.sequence, tempo=tempo))
        .with_duration(1)
        .with_amps(0)
        .with_freqs(1)
        .with_pan(45)
...
first_phrase_1.with_rhythm(Itemstream("s s e e e. e. q".split(), notetype=notetypes.rhythm, tempo=tempo))
...
first_phrase_1.post_processes = [post_process]
first_phrase_1.note_limit = 300
...
container.add_generator(first_phrase_1)
container.add_generator(first_phrase_2)

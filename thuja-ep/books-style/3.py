...
second_line.streams[keys.amplitude] = Itemstream([2])
...
third_line.streams[keys.amplitude] = Itemstream([3])
second_line.streams[keys.frequency] = Itemstream([1])
...
cs_utils.play_csound("generic-index.orc", g, silent=True, args_list=['-odac1', '-W'])

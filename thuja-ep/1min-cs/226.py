...
a.gen.start_time = 4
a.gen.streams[keys.frequency].streammode = streammodes.random
a.gen.streams[keys.rhythm].tempo = 240

b.gen.start_time = 4
b.gen.streams[keys.frequency].streammode = streammodes.random
b.gen.streams[keys.rhythm].tempo = 240
...
c.gen.streams[keys.frequency] = Itemstream("c6 b5 c6 b5 c6 b5 g e c5 b4".split(), notetype=notetypes.pitch, streammode=streammodes.sequence)
c.with_duration([.01]*5+[.05]*5)
c.with_percent(.2)
c.with_amps(.2)

d = copy.deepcopy(c).with_pan(0)
d.gen.streams[keys.rhythm].tempo = 240
d.gen.start_time = 16


e = copy.deepcopy(c).with_pan(90)
e.gen.streams[keys.rhythm].tempo = 240
e.gen.start_time = 16

f = copy.deepcopy(c).with_pan(45)
f.gen.streams[keys.rhythm].tempo = 60
f.gen.start_time = 24
f.with_rhythm(Itemstream("e.".split(), notetype=notetypes.rhythm, streammode=streammodes.sequence, tempo=120))
f.gen.streams[keys.frequency] = Itemstream("a1 c2 r c e r e g g g r r r ".split(), notetype=notetypes.pitch, streammode=streammodes.sequence)
...
container.gen.add_generator(b.gen)
container.gen.add_generator(c.gen)
container.gen.add_generator(d.gen)
container.gen.add_generator(e.gen)
container.gen.add_generator(f.gen)

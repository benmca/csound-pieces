...
(a2.with_rhythm(Itemstream(['w+w'] , notetype=notetypes.rhythm, streammode=streammodes.sequence))
 ...
 .with_amps(.5)
 .with_pitches(Itemstream(['e5', 'ds5', 'cs5', 'b4', 'a4', 'gs4', 'fs4' ], notetype=notetypes.pitch, streammode=streammodes.sequence))
 .with_pan([45])
 .with_instr([2]))
...
a3 = a.deepcopy()
(a3.with_rhythm(Itemstream(['w+w'] , notetype=notetypes.rhythm, streammode=streammodes.sequence))
 .with_duration(lambda note: note.rhythm)
 .with_amps(.5)
 .with_pitches(Itemstream(['e5', 'ds5', 'cs5', 'b4', 'a4', 'gs4', 'fs4' ], notetype=notetypes.pitch, streammode=streammodes.random))
 .with_pan([45])
 .with_instr([2]))

a3.post_processes = [freq_to_file_5ths]
a3.instr(Itemstream([2]))

b = (
    BasicLine().with_rhythm(Itemstream('e. e. s s s e.+q'.split() , notetype=notetypes.rhythm, streammode=streammodes.sequence, tempo=180 ))
...
cs_utils.play_csound("255.orc", a, silent=True, args_list=['-o256.wav', '-W'])

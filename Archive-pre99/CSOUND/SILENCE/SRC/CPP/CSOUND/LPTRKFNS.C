...
void ptable(MYFLT fmin, MYFLT fmax, MYFLT esr, int windsiz)
{
        int   i, n;
...
{
static  MYFLT c = FL(0.00048175311);
static  MYFLT a1 = -FL(1.89919924), c1 = -FL(1.92324804), d1 = FL(0.985720370);
static  MYFLT a2 = -FL(1.86607670), c2 = -FL(1.90075003), d2 = FL(0.948444690);
static  MYFLT a3 = -FL(1.66423461), c3 = -FL(1.87516686), d3 = FL(0.896241023);
static  MYFLT c4 = -FL(0.930449120);

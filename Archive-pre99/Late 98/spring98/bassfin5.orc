...
kenv	linseg	0, .001, 10*p4, iatck-.002, 10*p4, .001, 20*p4, (p3-iatck)-.001, 15*p4, .001, 0
kpitch	expseg	1, iatck, 1, .001, ipitch, p3-iatck, ipitch2
...
mid:
ktmpnt	linseg	iatck, (p3-idur)-.001, ilength
kenv	linen	15*p4, .01, p3, .01
kpitch	expseg	1, idur+.001, 1, .001, ipitch, p8+.001, ipitch, (p3-idur)-.002, ipitch2
asig	pvadd	ktmpnt, kpitch, "gnawa.pvoc", 1, 512, 2
asig2	pvadd	ktmpnt, kpitch, "gnawa.pvoc", 1, 40, 2
asig3	pvadd	ktmpnt, kpitch, "gnawa.pvoc", 1, 7, 2
asig1=(asig+asig2+asig3)*kenv

...
asig1=(asig+asig2+asig3)*kenv; out for msg!
;index = (p4/50)
;asigall = (asig1) / 32767
;amsg = sin((asigall * (.5*ipi)) + index * sin((2*ipi) * asigall))
;asig1=amsg*6000*kenv
kgoto	rest
...
asig2	pvadd	ktmpnt, kpitch, "gnawa.pvoc", 1, 40, 2
asig3	pvadd	ktmpnt, kpitch, "gnawa.pvoc", 1, 7, 2
asig1=(asig+asig2+asig3)*kenv;kenv out for msg!
;index = (p4/50)
;asigall = (asig1) / 32767
;amsg = sin((asigall * (.5*ipi)) + index * sin((2*ipi) * asigall))
;asig1=amsg*6000*kenv
...
asig1 = atck*kenva;kenva out for msg!
;index = (p4/30)
;asigall = (asig1) / 32767
;amsg = sin((asigall * (.5*ipi)) + index * sin((2*ipi) * asigall))
;asig1=amsg*6000*kenv

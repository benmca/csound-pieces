...
;         icondfn, scnrat,  ivelf, imasf, ispgmtrxf, icntrf, idampf, kmasf, kspgstf, kcntr, kdamp, ilplkpos, irplkpos, kpos, kstrngth, ain, idisp, id
   scanu  icondfn,    .05,  ivelf, imasf, ispgmtrxf, icntrf, idampf, kmasf, kspgstf,    .2,  -.05,      .1,        .5,   .5,       0,   a0,  idisp,  1
...
f9 0 1024 10 1
; MASS STUDY - DYNAMIC
i1 0 2   80 7.00 1 1     2 6    3    4    5   .5  .4   12 4
i1 + .   80 7.07 1 1     2 6    3    4    55  .4  .5    8 2
i1 + 5   80 8.00 1 1     2 6    3    4    555 .6  .5    2 13
s
i1 0 2   80 7.00 1 11    2 66   33   44   5   .03 .06   7 2
i1 + .   80 7.07 1 11    2 66   33   44   55  .06 .01   3 2
i1 + 5   80 8.00 1 11    2 66   33   44   555 .1  .6    2 6
s
i1 0 2   80 7.00 1 111   2 666  333  444  5   .6  .1    8 2
i1 + .   80 7.07 1 111   2 666  333  444  55  .3  .5    3 2
i1 + 5   80 8.00 1 111   2 666  333  444  555 .5  .4    2 9
s
i1 0 2   80 7.00 1 1111  2 6666 3333 4444 5   .2  .5    6 3
i1 + .   80 7.07 1 1111  2 6666 3333 4444 55  .03 .1    2 5
i1 + 12  80 8.00 1 1111  2 6666 3333 4444 555 .01 .6    3 2
e
</CsScore>
</CsoundSynthesizer>

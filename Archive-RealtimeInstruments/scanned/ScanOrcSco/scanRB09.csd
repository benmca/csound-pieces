...
;         icondfn,iscnrat,ivelf,imasf, ispgmtrxf, icntrf, idampf, kmasf, kspgstf, kcntr, kdamp, ilplkpos, irplkpos, kpos, kstrngth, ain, idisp, id
   scanu  icondfn,iscnrat,ivelf,imasf, ispgmtrxf, icntrf, idampf, kmasf, kspgstf, kcntr,  -.05,      .1,        .5,   .5,       0,   a0,  idisp,  1
...
f9 0 1024 10 1
; SCANRATE STUDY
i1 0 2   80 7.00 1 1     2 6    3    4    5   .2  .2   2  2  3  1    .05
i1 + .   80 7.07 1 1     2 6    3    4    55  .2  .2   2  2  1  3    .01
i1 + 5   80 8.00 1 1     2 6    3    4    555 .2  .2   2  2  2  1    .1
i1 + 2   80 7.00 1 11    2 66   33   44   5   .2  .2   2  2  .2  .4  .05
i1 + .   80 7.07 1 11    2 66   33   44   55  .2  .2   2  2  .4  .8  .03
i1 + 5   80 8.00 1 11    2 66   33   44   555 .2  .2   2  2  .3  .01 .01
i1 + 2   80 7.00 1 111   2 666  333  444  5   .2  .2   2  2  .1  .2  .1
i1 + .   80 7.07 1 111   2 666  333  444  55  .2  .2   2  2  .01  .2 .2
i1 + 5   80 8.00 1 111   2 666  333  444  555 .2  .2   2  2  .5  .01 .02
i1 + 2   80 7.00 1 1111  2 6666 3333 4444 5   .2  .2   2  2  .1  .3  .06
i1 + .   80 7.07 1 1111  2 6666 3333 4444 55  .2  .2   2  2  .01 .02 .02
i1 + 20  80 8.00 1 1111  2 6666 3333 4444 555 .2  .2   2  2  .1  .001 .1
e
</CsScore>
</CsoundSynthesizer>

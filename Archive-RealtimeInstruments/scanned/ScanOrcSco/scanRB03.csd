...
;         icondfn, scnrat,  ivelf, imasf, ispgmtrxf, icntrf, idampf, kmasf, kspgstf, kcntr, kdamp, ilplkpos, irplkpos, kpos, kstrngth, ain, idisp, id
   scanu  icondfn,    .05,  ivelf, imasf, ispgmtrxf,      4,      5,     2,      .2,    .2,  -.05,      .1,        .5,   .5,       0,   a0,  idisp,  1
...
f9 0 1024 10 1
; SPRING MATRIX STUDY
i1 0 2   90 7.00 1 1 2 6 33
i1 + .   90 7.07 1 1 2 6 333
i1 + 5   90 8.00 1 1 2 6 33333
i1 + 2   90 7.00 1 111 2 6 33
i1 + .   90 7.07 1 111 2 6 333
i1 + 5   90 8.00 1 111 2 6 33333
i1 + 2   90 7.00 1 1111 2 6 33
i1 + .   90 7.07 1 1111 2 6 333
i1 + 12   90 8.00 1 1111 2 6 33333
e
</CsScore>
</CsoundSynthesizer>

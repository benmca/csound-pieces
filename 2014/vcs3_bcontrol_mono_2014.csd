...
FLcolor 230,230,224
gkosc1freq, giosc1freqhandle   FLknob  "freq", 0, 13, 0, 3, ihandleosc1freqval, $KNOBWIDTH, $FIRSTROWOFFSETX+$KNOBOFFSETX , $FIRSTROWOFFSETY+$KNOBOFFSETY
...
ga09     init 0 ; Oscillator 1 freq mod   Input ch.2 / Keyboard
...
ioct 	octmidi
gaKeyb	init	(ioct-8)* i(gkKeyRange*100) + i(gkKeyOffset)
gktrig	init	1
gktrig1	init	1
gktrig2	init	1
gktrig3	init	1
;print ioct
;print (ioct-8)* i(gkKeyRange) + i(gkKeyOffset)
	endin
...
;printks "kstatus: %f, kchan:%f, kdata1:%f, kdata2:%f%n", 1, kstatus, kchan, kdata1, kdata2 
;

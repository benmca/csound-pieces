<Cabbage>
form caption("Glitch Delay") size(500, 130)
groupbox text("Glitch Delay"), bounds(0, 0, 500, 100)
rslider channel("delaytime"), bounds(10, 25, 70, 70), text("delaytime"), range(.1, 32, 32)
...
button bounds(280, 25, 70, 70), caption("In"), text("On", "Off"), channel("inputon"), value(0), colour("white"), fontcolour("white")
button bounds(350, 25, 70, 70), caption("Out"), text("On", "Off"), channel("outputon"), value(0), colour("white"), fontcolour("white")
button bounds(420, 25, 70, 70), caption("Reinit"), text("Sending", "Send"), channel("reinit"), value(1), colour("white"), fontcolour("white")
</Cabbage>
<CsoundSynthesizer>
<CsOptions>
-n -d
